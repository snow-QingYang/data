...
def return_depth_scale(render_size, ob_in_cams, mesh, rgb, depth, K, crop_ratio, xyz_map, normal_map=None, mesh_diameter=None, cfg=None, glctx=None, mesh_tensors=None,):
  ...
  return xyz_mapAs[:, 2, 80, 80] / xyz_mapBs[:, 2, 80, 80]
...
class PoseRefinePredictor:
  ...
  @torch.inference_mode()
  def predict(self, rgb, depth, K, ob_in_cams, xyz_map, normal_map=None, get_vis=False, mesh=None, mesh_tensors=None, glctx=None, mesh_diameter=None, iteration=5, center=None):
    '''
    @rgb: np array (H,W,3)
    ...
    for _ in range(iteration):
      ...
      #   B_in_cams[:, :3, 3]  = torch.as_tensor(center.reshape(1,3), device='cuda')
